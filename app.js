         ...
         <form id="update-goal-form" autocomplete="off">
          ...
          <div class="skill-panel">
            <div class="skill-name">
              <input class="editable" type="text" id="goal-name" name="goal-name" placeholder="Add your goal" required readonly autocomplete="off"/>
            </div>
            ...
            <div class="skill-info">
              <div class="data">
                ...
                <div class="dat"><p class="dat editable time-remain">000</p></div>
              </div>
              <div class="progress-data">
                <progress id="progress" name="progress" value="0" max="100"></progress>
                <input class="dat editable" type="number" id="progress-input" name="progress-input" value="" max="100" style="display: none;" placeholder="Add your progress(%)"/>
